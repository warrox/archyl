    ...
    <div className="max-w-7xl p-6 lg:px-8">
      <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-24 xl:py-32">
        ...
        <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
          Archyl is managing your flow of informations and keeping tracks on your memo, links and more ..
        </p>
...
const Header = () => {
  return (
    <header className="absolute top-0 left-0 p-6">
      <h1 className="font-display text-blue-950 text-2xl font-bold">ARCHYL</h1>
    </header>
  );
}
function App() {
